...
namespace TimeLineDataEditor
{
    public class TimeLineData
    {
        ...
        {
            this.Clear();
            this.AddOrUpdate(EditorConstant.KEY_DATE, null);
            this.AddOrUpdate(EditorConstant.KEY_INTRO, null);
            this.AddOrUpdate(EditorConstant.KEY_MEDIA, null);
            this.AddOrUpdate(EditorConstant.KEY_LIKE, null);
            this.AddOrUpdate(EditorConstant.KEY_COMMENT, null);
        }
        /// <summary>
        /// 添加或更新键值对
        /// </summary>
